  ...
  return (
    <form action={action} className={styles.form}>
      <div className={styles.formGrid}>
        ...
        <label className={`${field} ${styles.span2}`}><span>Target geographies</span><input name="targetGeographies" placeholder="Virginia, North Carolina" /><small>Separate multiple geographies with commas.</small></label>
